...
export default function CartItem({
  ...
  return (
    <div className="flex gap-[10px] lg:gap-[20px] lg:justify-between items-center border shadow lg:pb-[10px]">
      <img
      ...
      <div className="flex flex-wrap items-start lg:items-center gap-[15px] w-full justify-between">
        ...
        <p>TotalPrice</p>
        <button onClick={dlt} className="text-xs text-red-300 hover:text-red-600 font-bold">
          Delete
        </button>
      </div>
    </div>
